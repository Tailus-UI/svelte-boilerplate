<script>
    export let link, title, cover;
</script>

<a
    href="https://tailus.io/blocks/{link}/"
...
>
    <img
        ...
        height=""
    />
    <span class="-mt-2 block text-center text-lg font-medium text-gray-600 dark:text-gray-500">{title}</span>
</a>